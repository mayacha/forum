...
// var_dump($_SESSION);
// var_dump($_SERVER);
$traitementList = array('register','login','logout','post','topic','account','admin');
...
$traitementListAdmin = array();
if (isset($_GET['page_admin']) && in_array($_GET['page_admin'], $traitementList))
